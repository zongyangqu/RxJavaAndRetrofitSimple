...
public class RootFrameLayout extends FrameLayout {
    ...
    public int ivEmptyResID;
    public String tvEmptyMessage;
        ...
        switch (id) {
            ...
            case LAYOUT_EMPTYDATA_ID:
                if(mStatusLayoutManager.emptyDataVs != null) {
                    ...
                    ImageView ivEmpty = (ImageView) view.findViewById(R.id.icon);
                    TextView tvEmpty = (TextView)  view.findViewById(R.id.message);
                    if(ivEmptyResID != 0){
                        ivEmpty.setImageResource(ivEmptyResID);
                    }
                    if(null != tvEmptyMessage){
                        tvEmpty.setText(tvEmptyMessage);
                    }
